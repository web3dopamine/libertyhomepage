...
export const libertyChainData = {
  hero: {
    ...
    subtitle: "The first Reticulum-Meshtastic EVM Layer 1, engineered for|unmatched performance, zero gas fees, and instant finality.|No Gas. No Friction. No Permission. Just Liberty.",
