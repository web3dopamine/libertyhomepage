...
- Added animated dotted surface background to Ecosystem page using Three.js WebGL particles in teal/cyan color (#2EB8B8) with wave motion effects and graceful WebGL fallback
