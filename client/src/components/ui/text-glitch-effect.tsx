...
export function TextGlitch({ text, hoverText, href, className = "", delay = 0 }: TextGlitchProps) {
  ...
  return (
    <h1
      ref={textRef}
      className={`
        font-black leading-[0.85] tracking-tighter m-0 
        text-foreground/20
        bg-gradient-to-r from-foreground via-foreground to-foreground bg-clip-text bg-no-repeat
