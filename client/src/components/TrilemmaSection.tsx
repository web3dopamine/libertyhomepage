      ...
      <div className="max-w-7xl mx-auto px-8 py-16 relative z-10 w-full">
        <div className="text-center space-y-12">
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="mb-6">
              <CalloutBadge 
                text="210M TOTAL Liberty Supply" 
                data-testid="badge-supply"
              />
            </div>
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black leading-[0.85] tracking-tight" data-testid="text-trilemma-title">
              Liberty Chain <em className="gradient-text not-italic">rewrites</em> the rules.
            </h2>

            <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold gradient-text" data-testid="text-trilemma-tagline">
              All in one.
            </p>
          </div>
