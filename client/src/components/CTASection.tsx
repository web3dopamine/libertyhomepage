    ...
    <div className="flex-1 flex items-center justify-center">
      <div className="max-w-5xl mx-auto px-8 text-center">
        ...
        >
          ...
          {/* Main headline */}
          <h2 className="text-6xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tighter" data-testid="text-cta-title">
            <SplitText type="words">Start Building on</SplitText>
            <br />
            <span className="gradient-text">Liberty Chain</span>
          </h2>

          <p className="text-2xl md:text-3xl text-muted-foreground max-w-3xl mx-auto leading-relaxed" data-testid="text-cta-subtitle">
          ...
          >
            <Button size="lg" className="group text-lg px-8 py-6 h-auto" data-testid="button-start-building-cta">
              <Rocket className="mr-2 h-5 w-5" />
              Start Building Now
              <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="outline" className="group text-lg px-8 py-6 h-auto backdrop-blur-sm" data-testid="button-read-docs-cta">
