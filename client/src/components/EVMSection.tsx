        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-3 sm:space-y-4">
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-[0.9] tracking-tight" data-testid="text-evm-title">
                <SplitText type="words">
                  {libertyChainData.features.evmCompatibility.title}
                </SplitText>
              </h2>
              <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed" data-testid="text-evm-description">
                {libertyChainData.features.evmCompatibility.description}
              </p>
            </div>

            <Button size="lg" variant="outline" className="group w-full sm:w-auto text-sm sm:text-base" data-testid="button-developer-briefing">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full h-full" style={{ transformStyle: "preserve-3d" }}>
                  ...
                  <motion.div
                    ...
                    animate={{ y: [0, 20, 0], rotateX: [0, 180, 360] }}
                  ...
                  <motion.div
                    ...
                    animate={{ y: [0, -15, 0], rotateZ: [0, 180, 360] }}
